...
#iphone
        self.chek = Checkbutton(self.frame_1, text="Iphone",fg="black",bg="#006675", onvalue=6, offvalue=0, variable=self.escolha_marca,
                                command=self.chek_box_s)
        self.chek.place(relx=0.264, rely=0.40, relwidth=0.11, relheight=0.05)
...
# CHEK QUE MUDA O STATUS DO APARELHO
        ...
        self.chek = Checkbutton(self.frame_1, text="    Pronto",bg="#006675", onvalue=1, offvalue=0, variable=self.status,command=self.situacao)
        self.chek.place(relx=0.70, rely=0.4, relwidth=0.19, relheight=0.05)

        self.chek = Checkbutton(self.frame_1, text="Entregue",bg="#006675", onvalue=2, offvalue=0, variable=self.status,command=self.dar_baixa)
        self.chek.place(relx=0.64, rely=0.4, relwidth=0.1, relheight=0.05)
    def botoes(self):
#criaçao dos botoes
        self.bot_limpar = atk.Button3d(self.frame_1, bg="#006675", text="Limpar", command=self.limpa_tela)
        self.bot_limpar.place(relx=0.15, rely=0.76, relwidth=0.15, relheight=0.15)
# ADD CLIENTE
        self.bot_add = atk.Button3d(self.frame_1 ,text="  ADD \nCliente", command=self.adicione_cliente,bg="#006675")
        self.bot_add.place(relx=0.41, rely=0.05, relwidth=0.09, relheight=0.17)
# CONSULTAR CLIENTE
        self.bot_consultar_clientes = atk.Button3d(self.frame_1, bg="#006675", text="Clientes",
                                                   command=self.tela_consultar_db)
        self.bot_consultar_clientes.place(relx=0.41,rely=0.27, relwidth=0.09, relheight=0.12)
#GARANTIA
...
#ENTRADA DE AAPARELHO
        ...
        self.bot_entrada_aparelhos.place(relx=0.35, rely=0.76, relwidth=0.15, relheight=0.15)
# APARELHOS QUE ESTAO NA LOJA
        ...
        self.bot_aparelhos.place(relx=0.65, rely=0.01, relwidth=0.15, relheight=0.15)
# botao orçamento
        self.bot_orcamento = atk.Button3d(self.frame_1, bg="#006675", text="Orçamento",
                                          command=self.tela_orcamento)
        self.bot_orcamento.place(relx=0.85, rely=0.45, relwidth=0.15, relheight=0.15)

#BOTAO informaçoes
        self.bot_info = atk.Button3d(self.frame_1, text="Informaçoes", command=self.tela_informacoes, bg="#006675")
        self.bot_info.place(relx=0.65, rely=0.45, relwidth=0.15, relheight=0.15)
#botao telas
        self.bot_telas = atk.Button3d(self.frame_1, text="Telas", command=self.telas, bg="#006675")
        self.bot_telas.place(relx=0.65, rely=0.15, relwidth=0.15, relheight=0.12)
...
#criaçao dos labels
        ...
        self.entrada_id_smartphone.place(relx=0.65, rely=0.28, relwidth=0.35, relheight=0.10)

# criaçao das label DO NOME de pesquisa
        self.lb_nome = Label(self.frame_1, text="Nome \ndo Cliente", fg="black", bg="#006675",
                             font=("candara", "15", "bold italic"))
...
# setor de busca
        ...
        self.entrada_nome_i.place(relx=0.65, rely=0.64, relwidth=0.35, relheight=0.10)

        # LIMPAR BUSCA
        self.bot_limpar_BUSCA = atk.Button3d(self.frame_1, bg="#006675", text="Limpar", command=self.limpa_tela_inicial)
        self.bot_limpar_BUSCA.place(relx=0.65, rely=0.75, relwidth=0.15, relheight=0.12)
        self.bot_prontos = atk.Button3d(self.frame_1, bg="#006675", text="Prontos", command=self.select_prontos)
        self.bot_prontos.place(relx=0.65, rely=0.88, relwidth=0.10, relheight=0.12)
        self.bot_orcamento = atk.Button3d(self.frame_1, bg="#006675", text="Orçamento", command=self.select_orcamento)
        self.bot_orcamento.place(relx=0.775, rely=0.88, relwidth=0.10, relheight=0.12)
        self.bot_entregue = atk.Button3d(self.frame_1, bg="#006675", text="Entregues", command=self.select_entregues)
        self.bot_entregue.place(relx=0.90, rely=0.88, relwidth=0.10, relheight=0.12)

        # BOTAO BUSCAR
        self.bot_buscar = atk.Button3d(self.frame_1, bg="#006675", text="Buscar", fg="white",
                                       command=self.busca_clientes)
        self.bot_buscar.place(relx=0.85, rely=0.75, relwidth=0.15, relheight=0.12)
    def label(self):
...
#MODELO
        ...
        self.entrada_model.place(relx=0.15, rely=0.52, relwidth=0.15, relheight=0.10)
 ...
 # DESCRIÇÃO
        ...
        self.entrada_descricao.place(relx=0.15, rely=0.64, relwidth=0.35, relheight=0.10)
...
# ID DO CLIENTE PARA ADICIONAR O APARELHO
    ...
    def tabela_inicial(self):
        # criaçao da tabela
        self.tabela = ttk.Treeview(self.frame_2, height=4, columns=("coluna1", "coluna2", "coluna3", "coluna4", "coluna5","coluna6"))
